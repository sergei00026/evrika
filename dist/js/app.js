 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".sertificats-page__slider")) new core(".sertificats-page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".sertificats-page__prev",
                    nextEl: ".sertificats-page__next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".partners-page__slider")) new core(".partners-page__slider", {
        ...
        dtClass.forEach((element => {
            if (null != element.previousElementSibling && element.innerHTML) element.previousElementSibling.previousElementSibling.style.cssText = `border-bottom: 1px solid #e7e7e7;`;
        }));
        ...
        const resultLiter = document.querySelector(".result-calc__liter span");
        ...
        function benefit(toplivo, liters) {
            resultBenefit.innerHTML = Math.round(1.05 * +toplivo * +liters - +toplivo * +liters) + " ₽";
        }
        benefit(toplivo, liters);
        window["FLS"] = true;
        isWebp();
